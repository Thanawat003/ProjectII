...
public class Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int categoryID = intent.getIntExtra(QuizMain2.EXTRA_CATEGORY_ID, 0);
        String categoryName = intent.getStringExtra(QuizMain2.EXTRA_CATEGORY_NAME);
        String difficulty = intent.getStringExtra(QuizMain2.EXTRA_DIFFICULTY);
