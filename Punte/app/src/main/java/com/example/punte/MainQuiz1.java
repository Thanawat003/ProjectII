...
public class MainQuiz1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_quiz1);
    ...
    public void displayquestion () {
        if(anscnt <=4) {
            ...
            TextView navUsername = headerView.findViewById(R.id.lbl_question);
            ...
            navUsername.setText(questions[queue[numberofquestioncomplete]]);
